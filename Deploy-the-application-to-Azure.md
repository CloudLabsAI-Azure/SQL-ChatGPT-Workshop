...
1. In the **Azure AI Studio**, select **Deployments (1)** under Management and verify that **gpt-35-turbo** model is present with the deployment name as **sql-chatgpt-model**, review that the capacity of the module is set to **10K TPM**. Copy the OpenAI Model name into the text file for later use.
